...
This limitation does not apply with apex proxying. Cloudflare assigns a set of IP prefixes with [Static IP](https://developers.cloudflare.com/byoip/concepts/static-ips/) - cost associated with this product, reach out to your account team - to your account (or uses your own if you have [BYOIP](/byoip/)). This means that customers can create a standard `A` record to route traffic to your domain, which can support the domain apex.
